...
class GameWindow(QtGui.QMainWindow):
    ...
    def create_layout(self):
        ...
        new_game_action.setStatusTip('New game')
        new_game_action.triggered.connect(self.new_game)

        menubar = self.menuBar()
        actions_menu = menubar.addMenu('&Action')
        actions_menu.addAction(new_game_action)
        ...
        self.entry.returnPressed.connect(self.show_result)
    ...
    def show_result(self):
        self.statusBar().showMessage(self.entry.text())
