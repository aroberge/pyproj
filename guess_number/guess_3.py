...
Have the user play multiple "guess the number games" following the model
for a single game.

Keep track of the number of games played and attempts required to guess
the numbers.

Allow the player to quit either mid game or at the end of a given game.

Provide useful feedback at the end.

Structure your code with functions and include docstrings for each
function.

Use the Python idiom "if __name__ == '__main__' to allow your module
to be imported without actually being executed.
'''
